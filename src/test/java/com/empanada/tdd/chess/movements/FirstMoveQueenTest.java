...
public class FirstMoveQueenTest extends GenericFirstMove {

  MockMvc mockMvc;

  @Autowired
  public FirstMoveQueenTest(MockMvc mockInstance, ChessController chessController) {
  ...
  public void invalidQueenMove() throws Exception {
    final Request invalidRequest = new Request("E", "1", "F", "3");
    ...
    mockMvc.perform(post(moveEndpoint)
        ...
        .andExpect(content().string(containsString("Not able to move Queen from [E1] to [F3].")));
